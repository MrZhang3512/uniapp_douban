...
/* 4 */
/*!****************************************!*\
  !*** D:/vue/uni_app_douban/pages.json ***!
  \****************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 11 */
/*!********************************************!*\
  !*** D:/vue/uni_app_douban/store/index.js ***!
  \********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _api = __webpack_require__(/*! ../apis/api.js */ 14);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _slicedToArray(arr, i) {return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || _unsupportedIterableToArray(arr, i) || _nonIterableRest();}function _nonIterableRest() {throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");}function _unsupportedIterableToArray(o, minLen) {if (!o) return;if (typeof o === "string") return _arrayLikeToArray(o, minLen);var n = Object.prototype.toString.call(o).slice(8, -1);if (n === "Object" && o.constructor) n = o.constructor.name;if (n === "Map" || n === "Set") return Array.from(o);if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen);}function _arrayLikeToArray(arr, len) {if (len == null || len > arr.length) len = arr.length;for (var i = 0, arr2 = new Array(len); i < len; i++) {arr2[i] = arr[i];}return arr2;}function _iterableToArrayLimit(arr, i) {if (typeof Symbol === "undefined" || !(Symbol.iterator in Object(arr))) return;var _arr = [];var _n = true;var _d = false;var _e = undefined;try {for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) {_arr.push(_s.value);if (i && _arr.length === i) break;}} catch (err) {_d = true;_e = err;} finally {try {if (!_n && _i["return"] != null) _i["return"]();} finally {if (_d) throw _e;}}return _arr;}function _arrayWithHoles(arr) {if (Array.isArray(arr)) return arr;}
...
new _vuex.default.Store({
  ...
  actions: {
    ...
    //获取当前热映的电影
    getNowPlayingList: function getNowPlayingList(context) {
      (0, _api.getNowMovie)({
        start: "0",
        count: "8",
      ...
      then(function (result) {var _result = _slicedToArray(
        result, 2),error = _result[0],data1 = _result[1];
    ...
    //获取即将上映的电影
    getSoonPlayingList: function getSoonPlayingList(context) {
      (0, _api.getSoonMovie)({
        start: "0",
        count: "8",
        city: "context.state.city" }).
      then(function (result) {var _result2 = _slicedToArray(
        result, 2),error = _result2[0],data1 = _result2[1];
    ...
    //获取新片榜
    getnewBestPlayingList: function getnewBestPlayingList(context) {
      (0, _api.getNewBestMovie)({
        start: "0",
        count: "8",
        city: "context.state.city" }).
      then(function (result) {var _result3 = _slicedToArray(
        result, 2),error = _result3[0],data1 = _result3[1];
    ...
    //获取Top250
    getTop250PlayingList: function getTop250PlayingList(context) {
      (0, _api.getTOP250Movie)({
        start: "0",
        count: "8",
        city: "context.state.city" }).
      then(function (result) {var _result4 = _slicedToArray(
        result, 2),error = _result4[0],data1 = _result4[1];
...
/* 13 */
/*!*************************************************************!*\
  !*** D:/vue/uni_app_douban/static/js/qqmap-wx-jssdk.min.js ***!
  \*************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 14 */
/*!*****************************************!*\
  !*** D:/vue/uni_app_douban/apis/api.js ***!
  \*****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.getDetailMovie = exports.getTOP250Movie = exports.getNewBestMovie = exports.getSoonMovie = exports.getNowMovie = void 0;var baseUrl = "http://douban.uieee.com";
//正在上映的接口
var getNowMovie = function getNowMovie(params) {return (
    uni.request({
...
//即将上映的接口
exports.getNowMovie = getNowMovie;var getSoonMovie = function getSoonMovie(params) {return (
    uni.request({
...
//新片榜
exports.getSoonMovie = getSoonMovie;var getNewBestMovie = function getNewBestMovie(params) {return (
    uni.request({
...
//TOP250电影
exports.getNewBestMovie = getNewBestMovie;var getTOP250Movie = function getTOP250Movie(params) {return (
    uni.request({
...
//电影详情
exports.getTOP250Movie = getTOP250Movie;var getDetailMovie = function getDetailMovie(id) {return (
    uni.request({
      url: "".concat(baseUrl, "/v2/movie/subject/").concat(id),
      header: {
        'Content-Type': 'json' } }));};exports.getDetailMovie = getDetailMovie;
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ 1)["default"]))
